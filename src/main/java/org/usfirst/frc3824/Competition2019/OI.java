...
public class OI {
    ...
    public JoystickButton hatchDeployerOut;
    ...
    public OI() {
        ...
        hatchDeployerIn.whenReleased(new HatchPanelDeploy(false));
        ...
        deployerOut = new JoystickButton(joystickControl, 32);
        deployerOut.whenPressed(new HatchPanelDeploy(false));
        deployerIn = new JoystickButton(joystickControl, 32);
        deployerIn.whenPressed(new HatchPanelDeploy(false));
