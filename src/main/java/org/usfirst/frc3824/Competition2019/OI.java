...
public class OI {
    ...
    public JoystickButton climbDeploy;
    ...
    public OI() {
        ...
        climbRetract = new JoystickButton(joystickControl, 1);
        climbRetract.whenReleased(new ClimberRetract());
        climbDeploy = new JoystickButton(joystickControl, 1);
        climbDeploy.whenPressed(new ClimberExtend());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("ClimberExtend", new ClimberExtend());
        SmartDashboard.putData("ClimberRetract", new ClimberRetract());
