...
public class OI {
    ...
    public JoystickButton climbSideManual;
    public JoystickButton climbSideManualBack;
    ...
    public OI() {
        ...
        shooterStartSpinOut.whenPressed(new SetShooterSpeedStraight(-2200));
        ...
        shooterStartSpinIn.whenPressed(new SetShooterSpeedStraight(2200));
        shooterIntakeAngle = new JoystickButton(board, 4);
        shooterIntakeAngle.whenPressed(new ShooterAngleRotate(12000));
        ...
        climbSideManualBack = new JoystickButton(joystickDrive, 5);
        climbSideManualBack.whenPressed(new AllSystemsClimbSideManual_Back());
        climbSideManual = new JoystickButton(joystickDrive, 6);
        climbSideManual.whenPressed(new AllSystemsClimbSideManual());
        driveToTarget = new JoystickButton(joystickDrive, 10);
        ...
        cameraMode = new JoystickButton(joystickDrive, 9);
        ...
        climbSide = new JoystickButton(joystickDrive, 32);
        climbSide.whenPressed(new AllSystemsClimbSide());
        climbCenter = new JoystickButton(joystickDrive, 7);
