...
public class OI {
    ...
    public OI() {
        ...
        shooterResetAngleEncoder = new JoystickButton(joystickControl, 6);
        shooterResetAngleEncoder.whenPressed(new ResetShooterAngle());
        changePID = new JoystickButton(joystickControl, 7);
        changePID.whenPressed(new SetPIDValues());
        shooterAngleIntakeLevel = new JoystickButton(joystickControl, 8);
        ...
        straightSpinShooterWheels = new JoystickButton(joystickControl, 3);
        straightSpinShooterWheels.whenPressed(new SetShooterSpeedStraight(1.0));
        frontClimbRetract = new JoystickButton(joystickControl, 31);
        frontClimbRetract.whenReleased(new FrontClimberRetract());
        frontClimbDeploy = new JoystickButton(joystickControl, 31);
