...
import org.usfirst.frc3824.Competition2019.support.PathGenerator;
...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        // Test pathfinder waypoint addition and trajectory calculation
        pathGen.addWaypoint(-1, -4, -45);
        pathGen.addWaypoint(-2, -2, 0);
        pathGen.addWaypoint(0, 0, 0);

        pathGen.calcTrajectory();
    }
    ...
    public void teleopPeriodic() {
        ...
        if(iterator < pathGen.getLeftTraj().length()) {
            ...
            System.out.println("Path Position Y Left: " + pathSegmentLeft.y);
            System.out.println("Path Position X Right: " + pathSegmentRight.x);
            System.out.println("Path Position Y Right: " + pathSegmentRight.y);
        }
