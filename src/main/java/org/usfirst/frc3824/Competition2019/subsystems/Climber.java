...
public class Climber extends Subsystem {
    ...
    // tells whether or not driver has permission to climb incase of accidently hitting button during match
    private boolean climberPermission = false;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        initializeClimberTalons(climberFrontLeft, true, true); // setInvert, setSensorPhase
        initializeClimberTalons(climberFrontRight, false, true);
        initializeClimberTalons(climberBackLeft, false, true);
        initializeClimberTalons(climberBackRight, false, false);
    }
    ...
    {
        climberPermission = permission;
    }
    public boolean getPermission()
    {
        return climberPermission;
    }
    ...
    {
        return climberFrontRight.getSelectedSensorPosition();
    }
    ...
    {
        return climberBackRight.getSelectedSensorPosition();
    }
