...
public class Shooter extends Subsystem {
    ...
    public void periodic() {
        ...
        double ffDemand = Constants.SHOOTER_ANGLE_HORIZONTAL_STALL_OUTPUT * Math.cos(getAngleRadians());

        shooterAngleMaster.set(ControlMode.MotionMagic, shooterAngleSetpoint, DemandType.ArbitraryFeedForward, ffDemand);
    }
